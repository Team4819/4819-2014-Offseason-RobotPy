...
class Module:
    ...
    def __init__(self):
        ...
        #Set a run loop
        events.add_callback("enabled", self.subsystem, callback=self.run, inverse_callback=self.stop)
    ...
    def run(self):
        ...
        while not self.stop_flag:
            ...
            external_control = self.control_stream.get({"arms_down": False, "flipper_out": True, "intake_motor": 0})
